...
// Global per-user message budget: INCR + PEXPIRE, cap at limit
redis.defineCommand('rateLimitMsgGlobal', {
  numberOfKeys: 1,
  lua: `
local key = KEYS[1]
local limit = tonumber(ARGV[1]) or 60
local window = tonumber(ARGV[2]) or 60000
